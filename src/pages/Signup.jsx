...
const Signup = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            await authService.signup({ username, email, phone, password });
            navigate('/login');
        } catch (err) {
    ...
    return (
        <div className="flex min-h-screen bg-gray-50 font-sans">
            ...
            <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-sky-500 via-blue-600 to-indigo-700 flex-col justify-center items-center text-white p-12 relative overflow-hidden">
                ...
                <div className="z-20 text-center max-w-xl relative">
                    ...
                    <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight leading-tight drop-shadow-lg">
                        Join the <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">Movie-Z</span> Community
                    </h1>

                    <p className="text-lg text-blue-100 mb-10 font-light leading-relaxed max-w-lg mx-auto">
                        Unlock a universe of entertainment. Create your account today and start your cinematic journey.
                    </p>
                    ...
                    <div className="space-y-5 text-left inline-block w-full max-w-md">
                        ...
                        <div className="group flex items-center space-x-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:translate-x-2 cursor-default">
                            ...
                            <div>
                                <h3 className="font-bold text-white text-lg">Curate Your Library</h3>
                                <p className="text-blue-200 text-sm">Build your ultimate collection of favorites</p>
                            </div>
                        </div>
                        ...
                        <div className="group flex items-center space-x-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:translate-x-2 cursor-default">
                            ...
                            <div>
                                ...
                                <p className="text-blue-200 text-sm">Discover new gems you'll absolutely love</p>
                            </div>
                        </div>
                        ...
                        <div className="group flex items-center space-x-4 p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-300 transform hover:translate-x-2 cursor-default">
                            ...
                            <div>
                                <h3 className="font-bold text-white text-lg">Connect with Friends</h3>
                                <p className="text-blue-200 text-sm">Share reviews and watch together</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex justify-center items-center p-6 sm:p-12 bg-gray-50/50">
                <div className="w-full max-w-md bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 sm:p-12 border border-white/40 relative overflow-hidden transform transition-all duration-500 hover:shadow-blue-900/5" style={{ animation: 'fadeInUp 0.6s ease-out 0.1s forwards' }}>
                    ...
                    <div className="relative z-10">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-gray-500 text-sm mt-3 font-medium">Get started for free in seconds</p>
                        </div>
                        ...
                        <form onSubmit={onSubmit} className="space-y-5">
                            ...
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-gray-700 ml-1" htmlFor="phone">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="mt-6 text-center">
                                <Link to="/login" className="inline-block text-base font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 hover:scale-105 transition-all duration-300">
                                    Log In
                                </Link>
                            </div>
                        </div>
